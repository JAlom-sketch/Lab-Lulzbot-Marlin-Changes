...
#define STRING_CONFIG_H_AUTHOR "(Aleph Objects Inc., LulzBot Git Repository)" // <-- changed:  Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TAZ Workhorse Mosquito Edition" // <-- changed
 ...
 */
#define TEMP_SENSOR_0 67 // <-- changed
...
#define HEATER_0_MAXTEMP 450 // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 41.68 // <-- changed
  #define DEFAULT_Ki 6.87 // <-- changed
  #define DEFAULT_Kd 63.16 // <-- changed
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 500, 416} // <-- changed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {8000, 400, 200, 9000} // <-- changed
 ...
 */
  ...
  #define DEFAULT_YJERK 7.0 // <-- changed
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.2 // <-- changed:  Z offset: -below +above  [the nozzle]
...
#define X_MIN_POS -61 // <-- changed closer to 0 brings the toolhead to the left
#define Y_MIN_POS -20 // <-- changed Closer to 0 brings the toolhead forward
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION -10 // <-- changed
  #define RIGHT_PROBE_BED_POSITION 288 // <-- changed
  #define FRONT_PROBE_BED_POSITION -9 // <-- changed
  #define BACK_PROBE_BED_POSITION 291 // <-- changed
...
#define PREHEAT_1_TEMP_HOTEND 215 // <-- changed
...
#define LULZBOT_LCD_MACHINE_NAME "LulzBot TAZ" // <-- changed
#define LULZBOT_LCD_TOOLHEAD_NAME "Mosquito 0.5mm" // <-- changed
...
#define MAX_PROBE_X 288 // <-- changed
#define MIN_PROBE_Y -9 // <-- changed
#define MIN_PROBE_X -10 // <-- changed
