...
#define STRING_CONFIG_H_AUTHOR "(FAME 3D Inc., LulzBot Git Repository)" // <-- changed:  Who made the changes.
...
#define LULZBOT_TOOLHEAD_M115_TYPE "HardenedSteel" // <-- changed
...
#define LULZBOT_LCD_TOOLHEAD_NAME "HS 0.8mm" // <-- changed
