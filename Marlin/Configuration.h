...
#define STRING_CONFIG_H_AUTHOR "(Fame 3D Inc, Lulzbot Git Repository)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lulzbot Mini2" //changed
...
#define TEMP_BED_WINDOW          10  // changed (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_BED_HYSTERESIS      10  // changed (°C) Temperature proximity considered "close enough" to the target
...
#define HEATER_0_MAXTEMP 385 //changed
...
#define BED_MAXTEMP      130 //changed
...
#define EXTRUDE_MINTEMP 150 //changed
...
#define Z_HOMING_HEIGHT  4      //changed, uncommented (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    0.5  //changed (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.3  //changed (mm) Default layer height for the G26 Mesh Validation Tool.
    #define MESH_TEST_HOTEND_TEMP  230    //changed (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
  ...
  #define GRID_MAX_POINTS_X 4      //changed Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y 4      //changed
...
#if ENABLED(LCD_BED_LEVELING) //changed, uncommented
  #define MESH_EDIT_Z_STEP  0.05 //changed (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        //changed,uncommented Add a menu to edit mesh points
#endif
 ...
 */
#define EEPROM_SETTINGS     //changed,uncommented Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of PROGMEM. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  //changed,uncommented Init EEPROM automatically on any errors.
#endif
...
#define PREHEAT_1_TEMP_BED     60 //changed
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 250 //changed
#define PREHEAT_2_TEMP_BED    100 //changed
 ...
 */
#define NOZZLE_PARK_FEATURE //changed, uncommented
 ...
 *
 */
#define NOZZLE_CLEAN_FEATURE //changed, uncommented
  ...
  #define NOZZLE_CLEAN_START_POINT  {45, 173, 1} //changed
  ...
  //#define NOZZLE_CLEAN_GOBACK //changed, commented
 ...
 */
#define PRINTCOUNTER //changed,uncommented
 ...
 *
 */
#define SDSUPPORT //changed,uncommented
 ...
 */
#define SPI_SPEED SPI_FULL_SPEED //changed,uncommented
#define SPI_SPEED SPI_FULL_SPEED //changed, uncommented
#define SPI_SPEED SPI_FULL_SPEED //changed, uncommented
...
//
#define ENCODER_PULSES_PER_STEP 2 //changed,uncommented

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //changed, uncommented
...
//
#define REVERSE_ENCODER_DIRECTION //changed,uncommented
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //changed,uncommented
