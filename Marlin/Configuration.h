...
#define STRING_CONFIG_H_AUTHOR "(FAME3D, LulzBot Git Repository)" // <-- changed:  Who made the changes.
...
#define EXTRUDE_MINTEMP 0 // <-- changed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {300, 300, 30, 40} // <-- changed
...
#define Z_PROBE_LOW_POINT          0 // <-- changed:  Farthest distance below the trigger-point to go before stopping
...
//
#define LULZBOT_TOUCH_UI // <-- changed
...
#define LULZBOT_AERO_UNLOAD_PURGE_FEEDRATE 1.7 // <-- changed
