...
#if defined(LULZBOT_Mini3)
  #define MiniV3
  #define LULZBOT_CUSTOM_MACHINE_NAME "LulzBot Mini 3"
  #define LULZBOT_LCD_MACHINE_NAME "Mini 3"
  #define LULZBOT_MACHINE_UUID "2b294a98-383d-11ed-a261-0242ac120002"
#endif
 ...
 */
#if ANY(TAZPro, MiniV2, MiniV3, TAZProXT, Sidekick_289, Sidekick_747)
