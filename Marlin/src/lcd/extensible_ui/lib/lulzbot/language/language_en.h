...
namespace Language_en {
  ...
  PROGMEM Language_Str COLOR_TOUCH_PANEL        = u8"Color Touch Panel";
    ...
    PROGMEM Language_Str ABOUT_ALEPH_OBJECTS      = u8"© 2021 FAME 3D\n\nwww.lulzbot.com";
  #else
    PROGMEM Language_Str ABOUT_ALEPH_OBJECTS      = u8"(C) 2021 FAME 3D\n\nwww.lulzbot.com";
  #endif
  ...
  PROGMEM Language_Str LOAD_FILAMENT            = u8"Load/Extrude";
