...
#if BOTH(TOUCH_UI_FTDI_EVE, CUSTOM_MENU_MAIN) && NONE(TOUCH_UI_LULZBOT_BIO, TOUCH_UI_COCOA_PRESS)
...
#endif // TOUCH_UI_FTDI_EVE && CUSTOM_MENU_MAIN && !TOUCH_UI_LULZBOT_BIO && !TOUCH_UI_COCOA_PRESS
