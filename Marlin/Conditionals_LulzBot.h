...
#define LULZBOT_MANUAL_FEEDRATE_E             2.0 // mm/sec
...
/**************************** MINI TOOLHEADS ***********************************/
    ...
    #define LULZBOT_TOOLHEAD_X_MAX_ADJ         3  //was0   2
    #define LULZBOT_TOOLHEAD_X_MIN_ADJ         -9 //was 0
    #define LULZBOT_TOOLHEAD_Y_MAX_ADJ         -24 //was -18,-20
    #define LULZBOT_TOOLHEAD_Y_MIN_ADJ         0  //was 0,-2 -15
    #define LULZBOT_TOOLHEAD_Z_MAX_ADJ         -1.4 //was -3
...
//          16 chars max                            ^^^^^^^^^^^^^^^
    ...
    #define LULZBOT_E_STEPS                        415 //was 833
...
//          16 chars max                            ^^^^^^^^^^^^^^^
    #define LULZBOT_M115_EXTRUDER_TYPE             "SE 0.5mm"
    #define LULZBOT_X_MAX_ENDSTOP_INVERTING        LULZBOT_NORMALLY_CLOSED_ENDSTOP
    #define LULZBOT_E3D_Titan_Aero_V6
    #define LULZBOT_E_STEPS                        420
...
#if defined(LULZBOT_IS_MINI) && defined(LULBZOT_CALIBRATION_GCODE)
...
#elif defined(LULZBOT_IS_TAZ) && defined(LULZBOT_IS_XT) && defined(LULZBOT_USE_Z_BELT)
    #define LULZBOT_STANDARD_Z_MIN_POS          -2
...
/************************** ADVANCED PAUSE / FILAMENT CHANGE ***********************/
    ...
    #define LULZBOT_FILAMENT_CHANGE_FAST_LOAD_LENGTH 65
    ...
    #define LULZBOT_FILAMENT_CHANGE_UNLOAD_FEEDRATE 8 // mm/s
    ...
    #define LULZBOT_NOZZLE_PARK_POINT { 100, (LULZBOT_Y_MAX_POS -  30), 20 }
#endif
